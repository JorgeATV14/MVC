                ...
                <table class="table table-striped">
                    ...
                    for ($i = 0; $i < count($datos); $i++) {
                        ...
                        <tr>
                            ...
                            <td><a href="../index.php?c=servicio&&a=actualizar&&id=<?=$datos[$i]['id']?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a><a href="../index.php?c=servicio&&a=eliminar&&id=<?=$datos[$i]['id']?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></td>
